export const experiences = [
  {
    company: "OptimaGeeks",
    role: "Associate Software Engineer · MERN Stack",
    location: "Lahore, Pakistan",
    period: "Jul 2025 - Dec 2025",
    contributions: [
      "Contributed to a Chrome extension integrating Zoho CRM and Supabase, reducing manual data entry through workflow automation.",
  ...
  },
  {
    ...
    contributions: [
      "Contributed to a marketing dashboard integrating advertising and CRM platforms for centralized reporting and lead management.",
