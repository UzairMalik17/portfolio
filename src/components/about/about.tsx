        ...
        <div className="mt-10 grid gap-8 lg:grid-cols-[120px_minmax(0,1fr)]">
          ...
          <div className="max-w-2xl">
            <div className="flex flex-col gap-6 text-base leading-relaxed text-[var(--foreground-secondary)]">
              <p>
                I&apos;m a software engineer focused on modern web applications,
                backend systems, and API development. I enjoy working across the
                stack, from designing application interfaces to building the
                services and integrations behind them.
              </p>
              ...
              <p>
                More recently, I&apos;ve been exploring AI-enhanced software and
                how AI can be integrated into practical applications rather than
                treated as a feature on its own.
              </p>
            </div>
          </div>
        </div>
